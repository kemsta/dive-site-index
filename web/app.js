(() => {
  ...
  const I18N = {
    en: {
      ...
      hero_tagline: "open to contributions and reuse.",
      hero_intro: "A multilingual, source-backed directory with maps, regional browsing and UDDF exports for use in other applications.",
      geography: "Geography",
    ...
    ru: {
      ...
      hero_tagline: "открытые для правок и интеграций.",
      hero_intro: "Многоязычный каталог с картой, навигацией по регионам и экспортом UDDF для использования в других приложениях.",
      geography: "География",
