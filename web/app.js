(() => {
  ...
  const I18N = {
    en: {
      ...
      home_eyebrow: "Open dive-site catalog",
      hero_title: "Dive-site catalog,",
      hero_tagline: "open to corrections and reuse in other applications.",
      hero_intro: "Multilingual descriptions, maps, regional browsing and UDDF exports.",
      about_title: "About the catalog",
      about_body: "Dive Site Index is a multilingual catalog of dive sites. Suggest new dive sites or corrections, or reuse the data in another application.",
      suggest_site: "Suggest a dive site",
      correct_data: "Correct data",
      data_terms: "Data use terms",
    ...
    ru: {
      ...
      about: "О каталоге",
      contribute: "Дополнить каталог",
      report_problem: "Сообщить о проблеме",
      data_license: "Лицензия данных",
      project_information: "Информация о проекте",
      home_eyebrow: "Открытый каталог дайв-сайтов",
      hero_title: "Каталог дайв-сайтов,",
      hero_tagline: "открытый для правок и использования в других приложениях.",
      hero_intro: "Многоязычные описания, карта, навигация по регионам и экспорт UDDF.",
      about_title: "О каталоге",
      about_body: "Dive Site Index — многоязычный каталог дайв-сайтов. Предлагайте новые дайв-сайты или исправления либо используйте данные в своём приложении.",
      suggest_site: "Предложить дайв-сайт",
      correct_data: "Исправить данные",
      data_terms: "Условия использования данных",
      catalog_actions: "Действия с каталогом",
      geography: "География",
